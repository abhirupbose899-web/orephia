    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-primary/5 to-white">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center px-4 z-10">
          ...
          <h1 className="font-serif text-6xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight whitespace-pre-line bg-gradient-to-br from-[#E8B4B8] via-[#B76E79] to-[#D4A5A5] bg-clip-text text-transparent drop-shadow-2xl [text-shadow:_0_2px_20px_rgba(183,110,121,0.6)]" data-testid="text-hero-title">
            {heroTitle}
          </h1>
