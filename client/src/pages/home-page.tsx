    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-primary/5 to-white">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center px-4 z-10">
          ...
          <h1 className="font-serif text-6xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight whitespace-pre-line text-white drop-shadow-2xl" data-testid="text-hero-title">
            {heroTitle}
          </h1>
