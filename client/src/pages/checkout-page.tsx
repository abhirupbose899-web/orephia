              ...
              <Card className="p-6">
                ...
                <div className="space-y-4 mb-6">
                  <div className="border rounded-lg p-4 bg-muted/30">
                    <p className="text-sm text-muted-foreground">
                      Payment processing with Razorpay will be integrated after API keys are configured.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <Button onClick={() => setStep(3)} className="flex-1" data-testid="button-continue-to-review">
                    Continue to Review
                  </Button>
                </div>
              </Card>
